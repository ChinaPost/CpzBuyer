...
<script
	...
	<script>
		...
		$(document).on('ready', function() {
			...
			var addInp="?systemNo=&systemTyoe=&linkType=&linkNo=&linkTime=";
			$("#addIn").val(addInp);
			var updateInp="?systemNo=&systemTyoe=&linkType=&linkNo=&linkTime=";
			$("#updateIn").val(updateInp);
			var deleteInp="?systemNo=";
...
var requesturl='http://localhost:8080/'+projectName+'cpzterminfolink/query.do'+searchInp;
			
				$.ajax({
					type:'POST',
					url:'cpzterminfolink/query.do'+searchInp,
					data:{
					},
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://localhost:8080/'+projectName+'cpzterminfolink/insert.do'+addInp;
			
				$.ajax({
					type:'POST',
					url:'cpzterminfolink/insert.do'+addInp,
					data:{
					},
					success:function(result){
							var returndata = result.returnData;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://localhost:8080/'+projectName+'/cpzterminfolink/update.do'+updateInp;
			
				$.ajax({
					type:'POST',
					url:'cpzterminfolink/update.do'+updateInp,
					data:{
					},
					success:function(result){
							var returndata = result.returnData;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://localhost:8080/'+projectName+'/cpzterminfolink/delete.do'+deleteInp;
			
				$.ajax({
					type:'POST',
					url:'cpzterminfolink/delete.do'+deleteInp,
					data:{
					},
					success:function(result){
							var returndata = result.returnData;
