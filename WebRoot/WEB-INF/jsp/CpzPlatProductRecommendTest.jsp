...
<script
	...
	<script>
		...
		$(document).on('ready', function() {
			...
			var addInp="?Id=&productId=&channelNo=&saleType=&startTime=&endTime=&createTime=&remark1=";
			$("#addIn").val(addInp);
			var updateInp="?Id=&productId=&channelNo=&saleType=&startTime=&endTime=&createTime=&remark1=";
...
var requesturl='http://localhost:8080/'+projectName+'cpzplatproductrecommend/query.do'+searchInp;
			
				$.ajax({
					type:'POST',
					url:'cpzplatproductrecommend/query.do'+searchInp,
					data:{
					},
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://localhost:8080/'+projectName+'cpzplatproductrecommend/insert.do'+addInp;
			
				$.ajax({
					type:'POST',
					url:'cpzplatproductrecommend/insert.do'+addInp,
					data:{
					},
					success:function(result){
							var returndata = result.returnData;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://localhost:8080/'+projectName+'/cpzplatproductrecommend/update.do'+updateInp;
			
				$.ajax({
					type:'POST',
					url:'cpzplatproductrecommend/update.do'+updateInp,
					data:{
					},
					success:function(result){
							var returndata = result.returnData;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://localhost:8080/'+projectName+'/cpzplatproductrecommend/delete.do'+deleteInp;
			
				$.ajax({
					type:'POST',
					url:'cpzplatproductrecommend/delete.do'+deleteInp,
					data:{
					},
					success:function(result){
							var returndata = result.returnData;
