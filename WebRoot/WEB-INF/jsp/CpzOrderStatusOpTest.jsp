...
<script
	...
	<script>
		...
		$(document).on('ready', function() {
			...
			var addInp="?orderNo=&orderStatus=&opFalg=";
			$("#addIn").val(addInp);
			var updateInp="?orderNo=&orderStatus=&opFalg=";
...
var requesturl='http://localhost:8080/'+projectName+'cpzorderstatusop/query.do'+searchInp;
			
				$.ajax({
					type:'POST',
					url:'cpzorderstatusop/query.do'+searchInp,
					data:{
					},
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://localhost:8080/'+projectName+'cpzorderstatusop/insert.do'+addInp;
			
				$.ajax({
					type:'POST',
					url:'cpzorderstatusop/insert.do'+addInp,
					data:{
					},
					success:function(result){
							var returndata = result.returnData;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://localhost:8080/'+projectName+'/cpzorderstatusop/update.do'+updateInp;
			
				$.ajax({
					type:'POST',
					url:'cpzorderstatusop/update.do'+updateInp,
					data:{
					},
					success:function(result){
							var returndata = result.returnData;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://localhost:8080/'+projectName+'/cpzorderstatusop/delete.do'+deleteInp;
			
				$.ajax({
					type:'POST',
					url:'cpzorderstatusop/delete.do'+deleteInp,
					data:{
					},
					success:function(result){
							var returndata = result.returnData;
