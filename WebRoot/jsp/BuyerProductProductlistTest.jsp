...
<html>
<head>
<title>菜品或者套餐列表查询（菜品分类点更多）</title>
<script
	...
	<script>
		...
		$(document).on('ready', function() {
			var searchInp="?productCategoryId=&productType=";
...
var requesturl='http://'+host+'/'+projectName+'/buyerproductproductlist/query.do'+searchInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/buyerproductproductlist/insert.do'+addInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/buyerproductproductlist/update.do'+updateInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/buyerproductproductlist/delete.do'+deleteInp;
