...
var requesturl='http://'+host+'/'+projectName+'/cpzbuyerrefund/query.do'+searchInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/cpzbuyerrefund/insert.do'+addInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/cpzbuyerrefund/update.do'+updateInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/cpzbuyerrefund/delete.do'+deleteInp;
