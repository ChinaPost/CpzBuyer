...
var requesturl='http://'+host+'/'+projectName+'/cpzmessage/query.do'+searchInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/cpzmessage/insert.do'+addInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/cpzmessage/update.do'+updateInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/cpzmessage/delete.do'+deleteInp;
