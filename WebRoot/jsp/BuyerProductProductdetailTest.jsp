...
<html>
<head>
<title> 4.2.2.3菜品详情或者套餐详情查询</title>
<script
...
var requesturl='http://'+host+'/'+projectName+'/buyerproductproductdetail/query.do'+searchInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/buyerproductproductdetail/insert.do'+addInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/buyerproductproductdetail/update.do'+updateInp;
...
var pathName=window.document.location.pathname;
var projectName=pathName.substring(1,pathName.substr(1).indexOf('/')+1);
var requesturl='http://'+host+'/'+projectName+'/buyerproductproductdetail/delete.do'+deleteInp;
