...
// 4.2.2.3菜品详情或者套餐详情查询
public class BuyerProductProductdetailBean {
...
List<GspProductNormsMapBean> gspProductNormsMaps;/**商品规格关联表*/
...
List<CpzPlatProductNormsBean> cpzPlatProductNormss;/**平台商品规格表*/
	...
	public List getGspProductNormsMaps() {
		return gspProductNormsMaps;
	}
	public void setGspProductNormsMaps(List gspProductNormsMaps) {
		this.gspProductNormsMaps = gspProductNormsMaps;
	}
